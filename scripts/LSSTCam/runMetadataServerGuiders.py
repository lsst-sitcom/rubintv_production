...
print(f"Running LSSTCam guider metadata server at {locationConfig.location}...")

metadataDirectory = locationConfig.guiderDirectory
shardsDirectory = locationConfig.guiderShardsDirectory
channelName = "lsstcam_guider_metadata"
